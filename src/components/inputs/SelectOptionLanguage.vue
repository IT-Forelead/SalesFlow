...
<template>
  <div class="relative flex-1" ref="dropdown">
    <div @click="useDropdownStore().openSelectLanguage()"
      class="flex items-center justify-between rounded-lg dark:bg-slate-600 p-2 cursor-pointer hover:bg-gray-100">
    ...
    <ul v-if="useDropdownStore().isOpenSelectLanguage"
      class="absolute w-full dark:bg-slate-600 shadow rounded-md z-20 bottom-12 right-0 divide-y divide-gray-200">
