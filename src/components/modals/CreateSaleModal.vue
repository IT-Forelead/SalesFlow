      ...
      <div class="space-y-4">
        <div class="flex items-center space-x-4">
          <div class="flex-1">
            ...
            <input id="fullName" type="text" v-model="submitData.fullName" class="bg-slate-100 border-none text-slate-900 rounded-lg w-full py-2.5 placeholder-slate-400" placeholder="Famliya va ismini kiriting" />
          </div>
          <div class="flex-1">
            ...
            <input id="phone" type="text" v-model="submitData.phone" class="bg-slate-100 border-none text-slate-900 rounded-lg w-full py-2.5 placeholder-slate-400" placeholder="Telefon raqamni kiriting" />
          </div>
        </div>
      </div>
    </template>
