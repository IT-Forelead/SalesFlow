...
const createProduct = () => {
  if (!submitData.name) {
    ...
    const formattedSubmitData = {
      ...submitData,
      price: typeof submitData.price === 'string' ? parseFloat(submitData.price.replace(/\D/g, '')) : submitData.price,
      purchasePrice: typeof submitData.purchasePrice === 'string' ? parseFloat(submitData.purchasePrice.replace(/\D/g, '')) : submitData.purchasePrice,
    }
