      ...
      <div class="relative mb-8">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center space-x-2">
          <div @click="useModalStore().openCameraScannerModal()"
               class="flex items-center justify-center w-8 h-8 rounded-lg hover:bg-white hover:dark:bg-slate-800 cursor-pointer">
        ...
        <div class="space-y-2 md:space-y-4">
          ...
          <div class="space-x-3.5 space-y-2 md:text-left text-center">
            <button
              ...
              type="button"
              class="dark:text-white text-slate-600 bg-white dark:bg-slate-800  hover:dark:bg-slate-900 hover:bg-slate-100 focus:ring-4 focus:outline-none focus:ring-slate-300 rounded-xl border border-slate-200 text-sm font-medium px-4 py-2.5 hover:dark:text-white lowercase"
