      ...
      <div class="space-y-4">
        <div class="w-full mb-10">
          ...
          <div class="py-4 border-b border-slate-200 flex items-center justify-between">
            <p class="text-neutral-800 text-base font-normal">Mahsulot tarixi turi</p>
            <p class="text-sm leading-none text-gray-600 mr-3">{{ getHistoryType(selectedProductHistory?.historyType) }}</p>
          </div>
          <div class="py-4 border-b border-slate-200 flex items-center justify-between">
            <p class="text-neutral-800 text-base font-normal">Miqdori</p>
            <p class="text-sm leading-none text-gray-600 mr-3">{{ selectedProductHistory?.quantity }}</p>
          </div>
          <div class="py-4 border-b border-slate-200 flex items-center justify-between">
            <p class="text-neutral-800 text-base font-normal">Sotib olingan narxi</p>
            <p class="text-sm leading-none text-gray-600 mr-3">{{ useMoneyFormatter(selectedProductHistory?.purchasePrice) }}</p>
          </div>
          <div class="py-4 border-b border-slate-200 flex items-center justify-between">
            <p class="text-neutral-800 text-base font-normal">Sotish narxi</p>
            <p class="text-sm leading-none text-gray-600 mr-3">{{ useMoneyFormatter(selectedProductHistory?.salePrice) }}</p>
          </div>
        </div>
