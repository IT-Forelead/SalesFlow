        ...
        <div class="flex items-center space-x-4">
          <div class="flex-1 space-y-1">
            ...
            <money3 id="price" v-bind="moneyConf" v-model.number="submitData.purchasePrice"
              class="bg-slate-50 text-gray-900 dark:bg-slate-300 text-right border border-slate-200 text-base rounded-2xl focus:ring-green-400/40 focus:border-green-400/40 focus:ring-4 block w-full p-2.5">
            </money3>
          </div>
          <div class="flex-1 space-y-1">
            <label for="price" class="block text-left mb-2 text-slate-900 dark:text-white text-base font-medium after:text-red-500 ">
            ...
            <money3 id="price" v-bind="moneyConf" v-model.number="submitData.salePrice"
              class="bg-slate-50 dark:bg-slate-300 text-right border border-slate-200 text-slate-900 text-base rounded-2xl focus:ring-green-400/40 focus:border-green-400/40 focus:ring-4 block w-full p-2.5">
            </money3>
          </div>
        </div>
        <div class="flex items-center space-x-4">
          ...
          <div class="flex-1 space-y-1">
            ...
            <select id="default-type" v-model="submitData.productSaleType"
              class="bg-slate-100 dark:bg-slate-300 border-none text-slate-900 rounded-lg text-base md:text-lg block w-full h-11">
