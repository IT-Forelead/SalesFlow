...
<template>
  <div v-if="isOpen || isClosing" @click="handleBackgroundClick" class="fixed top-0 right-0 bottom-0 left-0 z-50 backdrop-blur-[2px] bg-gray-900/70 flex justify-end">
    <div :class="[{ 'slide-in-right': isOpen && !isClosing, 'slide-out-right': isClosing }, 'relative bg-white md:rounded-l-2xl shadow-xl min-h-screen w-[900px]']" ref="modal">
      <!-- Modal content -->
      <!-- Modal header -->
