...
<template>
  ...
  <div
    :class="[{ 'slide-in-right': isOpen && !isClosing, 'slide-out-right': isClosing }, 'z-50 dark:bg-slate-600 fixed right-0  md:rounded-l-2xl shadow-xl min-h-screen md:w-[900px] w-full']" :style="props.style">
    <!-- Modal content -->
    <!-- Modal header -->
